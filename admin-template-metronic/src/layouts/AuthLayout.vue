      ...
      >
        ...
        <div class="d-flex flex-stack px-lg-10">
          ...
          <div class="me-0">
            ...
            >
              <img class="w-20px h-20px rounded me-3" :src="currentLangugeLocale.flag" alt="" />
            ...
            >
              ...
              <div class="menu-item px-3">
                <a
                  @click="setLang('fa')"
                  href="#"
                  :class="{ active: currentLanguage === 'fa' }"
                ...
                >
                  <span class="symbol symbol-20px me-4">
                    <img
                      ...
                      class="rounded-1"
                      :src="getAssetPath('media/flags/iran.svg')"
                      alt=""
                    />
                  </span>
          ...
          <div class="d-flex fw-semibold text-primary fs-base gap-5">
            <router-link to="/contact" class="link-primary fw-bold">
              {{ translate("contactUs") }}
            </router-link>
          </div>
          <!--end::Links-->
