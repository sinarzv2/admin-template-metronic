                ...
                <div class="nav flex-column">
                  <template v-for="(plan, index) in plans" :key="index">
                    ...
                    >
                      ...
                      <div class="d-flex align-items-center me-2">
                        ...
                        <div class="flex-grow-1">
                          <h2 class="d-flex align-items-center fs-2 fw-bold flex-wrap">
                            ...
                            <span v-if="plan.label" class="badge badge-light-success ms-2 fs-7">{{
                              plan.label
                            }}</span>
                          </h2>
                      ...
                      <!--begin::Price-->
                      <div class="ms-5">
                        <button v-if="plan.custom" class="btn btn-sm btn-primary">
                          Contact Us
                        </button>
                        <template v-else>
                        ...
                        <template v-for="(feature, i) in plan.features" :key="i">
                          <template v-if="plan.features">
                            ...
                            >
                              ...
                              <template v-else>
                                <span class="fw-semibold fs-5 text-gray-400 flex-grow-1">
                                  {{ feature.title }}
                                </span>
