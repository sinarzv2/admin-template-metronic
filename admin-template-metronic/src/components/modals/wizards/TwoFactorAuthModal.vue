        ...
        <div class="modal-body scroll-y pt-10 pb-15 px-lg-17">
          ...
          <div :class="[state !== '' && 'd-none']">
            ...
            <p class="text-gray-500 fs-5 fw-semibold mb-10">
              ...
              app or SMS) to log into your account.
            </p>
            <!--end::Notice-->
              ...
              >
                ...
                <span class="d-block fw-semibold text-start">
                  ...
                  <span class="text-gray-500 fw-semibold fs-6">
                    Get codes from an app like Google Authenticator, Microsoft Authenticator, Authy
                    or 1Password.
                  </span>
                </span>
              </label>
              ...
              <div class="d-flex flex-stack flex-grow-1">
                ...
                <div class="fw-semibold">
                  <div class="fs-6 text-gray-600">
                    If you having trouble using the QR code, select manual entry on your app, and
