      ...
      <div class="card-body border-top p-9">
        ...
        <div class="d-flex flex-wrap align-items-center mb-8">
          <div id="kt_signin_email" :class="{ 'd-none': emailFormDisplay }">
            ...
            <div class="fs-6 fw-semibold text-gray-600">support@keenthemes.com</div>
          </div>
          ...
          >
            ...
            >
              <div class="row mb-6">
                ...
                <div class="col-lg-6">
                  <div class="fv-row mb-0">
                    <label for="confirmemailpassword" class="form-label fs-6 fw-bold mb-3"
        ...
        <div class="card-body border-top px-9 py-9">
          ...
          <label class="form-check form-check-custom form-check-solid align-items-start">
            ...
            <span class="form-check-label d-flex flex-column align-items-start">
              ...
              <span class="text-muted fs-6"
                >Receive notifications for consistently failing webhook API endpoints.</span
              >
            </span>
            <!--end::Label-->
          </label>
            ...
            <div class="d-flex flex-stack flex-grow-1">
              ...
              <div class="fw-semibold">
                ...
                <div class="fs-6 text-gray-600">
                  ...
                  you reset yousignr password. <br /><a class="fw-bold" href="#">Learn more</a>
                </div>
              </div>
              <!--end::Content-->
            </div>
