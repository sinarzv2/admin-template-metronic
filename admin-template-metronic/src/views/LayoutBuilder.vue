<template>
    ...
    <div class="card-body d-flex align-items-center py-8">
      ...
      <div class="ms-6">
        <p class="list-unstyled text-gray-600 fw-semibold fs-6 p-0 m-0">
          The layout builder will assist you in setting up your preferred layout for your project,
          generating a layout configuration, and previewing it in real-time. To preview the default
          layout configuration, simply empty your localStorage or press the 'Reset' button.
        </p>
      </div>
      <!--end::Description-->
    </div>
  ...
  <div class="card">
    ...
    <div class="card-body p-10 p-lg-15">
      ...
      <!--end::Heading-->
      <div class="py-5">
        This config is used as a <b>{{ themeName }}</b> layout config, you can update default values
        inside file
